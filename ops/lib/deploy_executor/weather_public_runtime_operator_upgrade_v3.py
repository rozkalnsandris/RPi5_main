...
ISSUE = 496
TRUSTED_CHECKOUT_NAME = "RPi5_main-weather-public-runtime-operator-upgrade-v3-trusted"
...
MINIMUM_TARGET_ANCESTOR = "4c4042af2ee5a29fefa20eb733fc3a8945796d35"
...
UPGRADE_CONTRACT_RELATIVE = Path("ops/deploy/weather-public-runtime-operator-upgrade-v3.json")
...
UPGRADE_ENTRYPOINT_RELATIVE = Path("ops/bin/rozkalns-weather-public-runtime-operator-upgrade-v3")
UPGRADE_MODULE_RELATIVE = Path("ops/lib/deploy_executor/weather_public_runtime_operator_upgrade_v3.py")
TEMP_NAME = ".rozkalns-weather-public-runtime-operator.compatibility-upgrade-v3.tmp"
ROOT_UID = 0
ROOT_GID = 0
...
def source_readiness() -> dict[str, Any]:
    return {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v3-source.v1",
        "issue": ISSUE,
        "caller_authority": (),
...
def _validate_upgrade_contract(value: dict[str, Any]) -> None:
    expected = {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v3.v1",
...
def _receipt(
    *,
    ...
    value: dict[str, Any] = {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v3-receipt.v1",
        "result": result,
