...
- Bare `START`, `START RPi5_main`, `turpini`, or equivalent continuation means normal **FAST-LANE v2.2**. FAST is the safe discovery/audit/non-FULL continuation lane; it is not the default implementation authority and does not activate `AUTO-RUN FULL`.
