...
ISSUE = 504
TRUSTED_CHECKOUT_NAME = "RPi5_main-weather-public-runtime-operator-upgrade-v4-trusted"
...
PREDECESSOR_SHA = "3a8ac3bfc777a9ddfd3fc843d81e4e84d83afebe"
MINIMUM_TARGET_ANCESTOR = "98f96818b64d0f5ddc91c6ddfeb619ceccb017ca"
...
TARGET_OLD_BLOB = "2332a62479fda1f3bfbe076723dec1e8b7f6d8a4"
TARGET_NEW_BLOB = "2be2a8128eca470fd4c233d88410c415e4c8d438"
TARGET_OLD_SHA256 = "3608fe01da9299eedff9276e0005ba4aaec92f3cfbe403303eeb1f4b9147b5e9"
TARGET_NEW_SHA256 = "f5eaeb395ac374f074e9bf60c8f899371738be7c7cca1208c475e189f7d27ee5"
UPGRADE_CONTRACT_RELATIVE = Path("ops/deploy/weather-public-runtime-operator-upgrade-v4.json")
...
UPGRADE_ENTRYPOINT_RELATIVE = Path("ops/bin/rozkalns-weather-public-runtime-operator-upgrade-v4")
UPGRADE_MODULE_RELATIVE = Path("ops/lib/deploy_executor/weather_public_runtime_operator_upgrade_v4.py")
TEMP_NAME = ".rozkalns-weather-public-runtime-operator.compatibility-upgrade-v4.tmp"
ROOT_UID = 0
ROOT_GID = 0
...
def source_readiness() -> dict[str, Any]:
    return {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v4-source.v1",
        "issue": ISSUE,
        "caller_authority": (),
...
def _validate_upgrade_contract(value: dict[str, Any]) -> None:
    expected = {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v4.v1",
...
def _receipt(
    *,
    ...
    value: dict[str, Any] = {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v4-receipt.v1",
        "result": result,
