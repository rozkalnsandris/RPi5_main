...
- source checkout convergence, candidate-ingress reproof, execution-ingress preparation, root-owned execution-bundle materialization/proof, root-owned handoff materialization/proof, candidate staging/proof all passed under separately bounded one-shot gates;
