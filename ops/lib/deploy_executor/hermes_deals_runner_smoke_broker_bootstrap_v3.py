...
from . import hermes_deals_runner_smoke_broker_bootstrap_v2 as v2

IMPLEMENTATION_ISSUE = base.IMPLEMENTATION_ISSUE
PAYLOAD_CLOSURE_ISSUE = 588
HISTORICAL_V1_TRUSTED_CHECKOUT_NAME = base.TRUSTED_CHECKOUT_NAME
HISTORICAL_V2_TRUSTED_CHECKOUT_NAME = v2.TRUSTED_CHECKOUT_NAME
TRUSTED_CHECKOUT_NAME = "RPi5_main-runner-smoke-broker-bootstrap-v3-trusted"
    ...
    ready.update(
        {
            ...
            "historical_v1_trusted_checkout_name": HISTORICAL_V1_TRUSTED_CHECKOUT_NAME,
            "historical_v2_trusted_checkout_name": HISTORICAL_V2_TRUSTED_CHECKOUT_NAME,
...
def observe_bootstrap(
    ...
    *,
    ...
    filesystem_state = _filesystem_state_v3(
        checkout,
        source_sha,
        host_root=host_root,
        uid=uid,
...
def failure_receipt(*, mutation_started: bool) -> Mapping[str, Any]:
    ...
    value["payload_closure_issue"] = PAYLOAD_CLOSURE_ISSUE
    return value
