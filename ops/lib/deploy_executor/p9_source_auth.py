...
HERMES_DEALS_SOURCE_REPOSITORY = "rozkalnsandris/hermes-deals"
HERMES_DEALS_SOURCE_REPOSITORY_ID = 1317143994
SOURCE_REPOSITORIES = {
    CONTROL_SOURCE_REPOSITORY: CONTROL_SOURCE_REPOSITORY_ID,
    HERMES_DEALS_SOURCE_REPOSITORY: HERMES_DEALS_SOURCE_REPOSITORY_ID,
}
