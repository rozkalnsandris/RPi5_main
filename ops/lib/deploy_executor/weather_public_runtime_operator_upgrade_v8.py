...
ISSUE = 597
TRUSTED_CHECKOUT_NAME = "RPi5_main-weather-public-runtime-operator-upgrade-v8-trusted"
...
PREDECESSOR_SHA = "db7946fc64067c11d16a5b10902edf1157544db5"
MINIMUM_TARGET_ANCESTOR = "0b1f03b86200b215ccd00449a659917cce574d39"
...
TARGET_OLD_BLOB = "e3d5b438c0876dc8dc59103493aa5d9783e2ceb1"
TARGET_NEW_BLOB = "319e864d0b7af4235ab1af662e9582c59abea8de"
TARGET_OLD_SHA256 = "f6255bf1e80d2918555b0814b0690add739041ac11512297d904fce5e8fc0cf1"
TARGET_NEW_SHA256 = "c9cddce6890039e50a80b16ce3cafed67a0273fea3e9dbfff29efd00deccb8a9"
UPGRADE_CONTRACT_RELATIVE = Path("ops/deploy/weather-public-runtime-operator-upgrade-v8.json")
CHECKOUT_CONTRACT_RELATIVE = Path(
    "ops/deploy/rpi5-main-weather-public-runtime-operator-upgrade-v8-trusted-checkout-bootstrap.json"
)
UPGRADE_ENTRYPOINT_RELATIVE = Path("ops/bin/rozkalns-weather-public-runtime-operator-upgrade-v8")
UPGRADE_MODULE_RELATIVE = Path("ops/lib/deploy_executor/weather_public_runtime_operator_upgrade_v8.py")
TEMP_NAME = ".rozkalns-weather-public-runtime-operator.compatibility-upgrade-v8.tmp"
ROOT_UID = 0
ROOT_GID = 0
...
def source_readiness() -> dict[str, Any]:
    return {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v8-source.v1",
        "issue": ISSUE,
        "caller_authority": (),
...
def _validate_upgrade_contract(value: dict[str, Any]) -> None:
    expected = {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v8.v1",
...
def _receipt(
    *,
    ...
    value: dict[str, Any] = {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v8-receipt.v1",
        "result": result,
