...
5. Control root: only after the P1A exact root application exists and Dashboard canary is accepted; preserve the more-specific GitHub webhook application unchanged;
