...
def _pem_marker(kind: str, *, end: bool = False) -> str:
    prefix = "END " if end else "BEGIN "
    return f"{PEM_BOUNDARY}{prefix}{kind}{PEM_BOUNDARY}"


PEM_ENVELOPES = {
    _pem_marker("RSA PRIVATE KEY"): _pem_marker("RSA PRIVATE KEY", end=True),
    _pem_marker("PRIVATE KEY"): _pem_marker("PRIVATE KEY", end=True),
}
