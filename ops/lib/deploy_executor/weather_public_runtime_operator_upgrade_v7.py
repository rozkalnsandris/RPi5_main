...
UPGRADE_CONTRACT_RELATIVE = Path("ops/deploy/weather-public-runtime-operator-upgrade-v7.json")
...
UPGRADE_ENTRYPOINT_RELATIVE = Path("ops/bin/rozkalns-weather-public-runtime-operator-upgrade-v7")
UPGRADE_MODULE_RELATIVE = Path("ops/lib/deploy_executor/weather_public_runtime_operator_upgrade_v7.py")
TEMP_NAME = ".rozkalns-weather-public-runtime-operator.compatibility-upgrade-v7.tmp"
ROOT_UID = 0
ROOT_GID = 0
...
def source_readiness() -> dict[str, Any]:
    return {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v7-source.v1",
        "issue": ISSUE,
        "caller_authority": (),
...
def _validate_upgrade_contract(value: dict[str, Any]) -> None:
    expected = {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v7.v1",
...
def _receipt(
    *,
    ...
    value: dict[str, Any] = {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v7-receipt.v1",
        "result": result,
