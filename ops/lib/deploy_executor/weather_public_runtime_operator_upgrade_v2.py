...
ISSUE = 491
TRUSTED_CHECKOUT_NAME = "RPi5_main-weather-public-runtime-operator-upgrade-v2-trusted"
...
PREDECESSOR_SHA = "36ce218ffd65af8c1bb904bd30037920f847808d"
MINIMUM_TARGET_ANCESTOR = "6219f91751063340a64453b5e525fca4283567ac"
...
TARGET_OLD_BLOB = "e48494077fc37125bca46d02c6020a0e4c04cd2f"
TARGET_NEW_BLOB = "c7f089f4535779e3ef507af4564b3fbadb2bbd2a"
TARGET_OLD_SHA256 = "cc93baecce1cb594ce1ed23c837d144b467c2c27b8004d5f04069422dfc4af06"
TARGET_NEW_SHA256 = "48c8c5fb0cdc005bf0e4fbb05a203297e05d7ef62689ddd0d6d717c13acc0fcb"
UPGRADE_CONTRACT_RELATIVE = Path("ops/deploy/weather-public-runtime-operator-upgrade-v2.json")
CHECKOUT_CONTRACT_RELATIVE = Path(
    "ops/deploy/rpi5-main-weather-public-runtime-operator-upgrade-v2-trusted-checkout-bootstrap.json"
)
UPGRADE_ENTRYPOINT_RELATIVE = Path("ops/bin/rozkalns-weather-public-runtime-operator-upgrade-v2")
UPGRADE_MODULE_RELATIVE = Path("ops/lib/deploy_executor/weather_public_runtime_operator_upgrade_v2.py")
TEMP_NAME = ".weather_public_runtime_operator.py.compatibility-upgrade-v2.tmp"
ROOT_UID = 0
ROOT_GID = 0
...
def source_readiness() -> dict[str, Any]:
    return {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v2-source.v1",
        "issue": ISSUE,
        "caller_authority": (),
...
def _validate_upgrade_contract(value: dict[str, Any]) -> None:
    expected = {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v2.v1",
...
def _receipt(
    *,
    ...
    value: dict[str, Any] = {
        "schema": "rozkalns-weather.public-runtime-operator-upgrade-v2-receipt.v1",
        "result": result,
