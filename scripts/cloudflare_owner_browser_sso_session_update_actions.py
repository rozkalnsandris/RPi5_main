...
def main() -> int:
    ...
    if os.environ.get("GITHUB_EVENT_NAME") != "issue_comment":
        ...
        return 2
    if os.environ.get("P1D04_CANARY") != CANARY_ID:
    ...
    try:
        ...
        write_client = CloudflareOrganizationSessionUpdateClient(write_token, DEFAULT_API_BASE)

        read_token = ""
        write_token = ""
        result = execute_canary(read_client, write_client, account_id)
